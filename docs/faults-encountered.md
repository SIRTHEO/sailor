...
| 165 | 11/09 | When an engine exhausts its quota, Sailor fails over to a different engine rather than rotating to another authenticated account of the same engine. | **closed in part** |
...
Counted from the fault store through fault 315, change 1 of its history, as it stood at 2026-09-23T17:30:59.633Z.
