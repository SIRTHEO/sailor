...
- `cargo test -p actions -j 1 --test a_candidate_leaves_only_through_the_gate` — the last gate before integration or a release lets a candidate leave, proved without a forge or a binary in service
