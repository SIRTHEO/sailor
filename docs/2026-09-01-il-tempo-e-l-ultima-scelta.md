...
## La regola esiste già, ed è di gyver

`whatsapp/.claude/rules/async-no-cron.md`, scritta mesi fa, apre così:
...
Il 31/08/2026 su gyver c'erano **31 rami orfani**. Per decidere che farne sono
...
`~/.config/sailor/flows/gyver/un-ramo-dichiara-come-finisce.flow.json`.

### Livello 4 — il timer, come rete

Passa ogni tanto e raccoglie ciò che i primi tre hanno perso. **Se i primi tre
esistono, la precisione del tick conta poco**: nel bot di gyver la rete gira ogni
