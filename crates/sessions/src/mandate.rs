...
pub struct Written {
    ...
    /// When the queue of events first heard from the session writing it.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub began: Option<i64>,
    /// The branches' commits since `began`, newest first: a fact about the
    /// repository, not a claim of authorship.
