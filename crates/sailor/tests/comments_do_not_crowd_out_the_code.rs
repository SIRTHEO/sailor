...
const LONG_BLOCKS_TODAY: usize = 773;

/// How many comments cite a date. Same rule: downwards only.
const DATED_COMMENTS_TODAY: usize = 318;
...
const COMMENT_LINES_NOT_IN_ENGLISH: usize = 12_925;
...
/// **TWO SHAPES OF COMMENT, BECAUSE STYLESHEETS HAVE NO `//`.** The `in_block`
/// travels from one line to the next: without it a ninety-line CSS banner would
/// count as a single line and the rest would pass for code.
