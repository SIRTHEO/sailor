...
fn home() -> PathBuf {
    ...
    match std::env::var("CLAUDE_CENSUS_HOME") {
        ...
        _ => PathBuf::from("/Users/theo/.claude"),
    }
}
...
e' protetto: la mette Theo).",
    ...
    let user = std::env::var("HOME").unwrap_or_else(|_| "/Users/theo".into());
    ...
    let mut roots: Vec<String> = if !injected.is_empty() {
        ...
        "/Users/theo/gyver/work/.claude".into(),
        format!("{user}/Library/LaunchAgents"),
        "/Users/theo/gyver/work/CLAUDE.md".into(),
        ]
    };
    if injected.is_empty() {
        ...
        for r in ["suite", "matching-engine", "whatsapp"] {
            roots.push(format!("/Users/theo/gyver/work/{r}/.claude"));
            roots.push(format!("/Users/theo/gyver/work/{r}/.github"));
            roots.push(format!("/Users/theo/gyver/work/{r}/package.json"));
            roots.push(format!("/Users/theo/gyver/work/{r}/CLAUDE.md"));
        }
    }
