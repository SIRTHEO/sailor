...
fn selftest() -> i32 {
    ...
    let names: Vec<(&str, Value, bool, &str)> = vec![
        (
            ...
            serde_json::json!({"displayName": "principale", "isMainWorktree": true,
                               "path": "/Users/theo/gyver/work/suite", "branch": "refs/heads/feat/x"}),
            true,
            "suite",
        ),
        (
        ...
        (
            ...
            serde_json::json!({"displayName": "matching-engine", "isMainWorktree": true,
                               "path": "/Users/theo/gyver/work/matching-engine",
    ...
    let aligns: Vec<(&str, Value, bool)> = vec![
        ...
        (
            ...
            serde_json::json!({"displayName": "suite", "isMainWorktree": true,
                               "path": "/Users/theo/gyver/work/suite",
        ...
        (
            ...
            serde_json::json!({"displayName": "feat/job-model", "isMainWorktree": true,
                               "path": "/Users/theo/personal/sailor",
