...
mod tests {
    ...
    fn the_settings_of_another_program_are_not_ours() {
        assert!(!config_file_is_ours("/Users/theo/.gemini/settings.json"));
        assert!(!config_file_is_ours("/Users/theo/.config/qualcosa/settings.json"));
        assert!(!config_file_is_ours("/Applications/Roba.app/settings.json"));
    }

    #[test]
    fn our_own_settings_stay_protected() {
        assert!(config_file_is_ours("/Users/theo/.claude/settings.json"));
        assert!(config_file_is_ours("/Users/theo/.claude/settings.local.json"));
    }
