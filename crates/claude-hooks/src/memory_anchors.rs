...
/// progetto: `~/.claude/projects/-Users-theo-gyver-work-suite/memory/x.md` parla
/// di `/Users/theo/gyver/work/suite`.
///
/// **La conversione all'indietro e' ambigua** e non si fa sostituendo i trattini:
/// `-Users-theo-gyver-work-matching-engine` darebbe `.../matching/engine`, che non
/// esiste. Si cammina invece dall'alto prendendo, a ogni passo, il prefisso piu'
/// lungo che sia davvero una cartella — cosi' `matching-engine` resta intero.
...
mod tests {
    ...
    fn a_project_name_with_a_hyphen_still_finds_its_repo() {
        // `matching-engine` e' una cartella sola: sostituire i trattini darebbe
        // `matching/engine` e dichiarerebbe sparito un repo vivo.
        let dir = scratch("repo-walk");
        let repo = dir.join("gyver/work/matching-engine");
