...
//! a-service è stato fatto con uno script Python e due regex: **168 rotte**
...
pub fn advice(command: &str, package_json: &str) -> String {
    ...
    format!(
        "Stai contando {domain} con una ricerca testuale. Questo repo le stampa \
         ...
         Il 18/08/2026 la stessa domanda sul a-service ha dato 168 rotte \
...
mod tests {
    ...
    /// Il `package.json` vero del a-service, ridotto ai campi che contano.
    const PKG: &str = r#"{
      "scripts": {
