...
/// `~/other-repo/work/suite/.claude/rules/x.md` e
...
mod tests {
    ...
    fn a_glob_alive_in_any_repo_is_not_reported() {
        ...
        let repos = vec![dir.join("suite"), dir.join("a-client")];
    ...
    fn a_rule_under_the_home_rules_dir_is_global() {
        ...
        assert!(
            !is_global("/home/someone/other-repo/work/suite/.claude/rules/x.md", &dir),
