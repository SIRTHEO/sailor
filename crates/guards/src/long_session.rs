...
mod tests {
    ...
    const DOC: &str = "/Users/theo/.claude/projects/-Users-theo-orca-general/memory/consegna-x.md";
    ...
    fn a_document_that_is_not_a_handoff_does_not_name_the_resume_point() {
        let lines = [
            handoff_call(),
            handoff_write("/Users/theo/orca/general/docs/consegna-finta.md"),
            handoff_write("/Users/theo/.claude/projects/p/memory/nota.md"),
        ];
    ...
    fn without_a_known_document_the_fallback_names_the_index() {
        let mut lines: Vec<String> = (0..100).map(turn).collect();
        lines.push(handoff_call());
        let index = "/Users/theo/.claude/projects/p/memory/MEMORY.md";
