...
const KNOWN_CLIS: &[KnownCli] = &[
    ...
    KnownCli {
        ...
        native_profiles_note: "nessun binario `antigravity` in PATH — ma il prodotto C'È, installato come `agy` (verificato il 01/09/2026: /home/someone/.local/bin/agy, `agy --version` dice 1.1.22, e i descrittori lo chiamano `agy`). Questa voce cerca quindi un nome che nessuno usa. I profili nativi restano non verificati: `agy --help` e i suoi sottocomandi non nominano nessun profilo.",
