...
mod tests {
    ...
    fn engine_missing_says_where_it_looked() {
        let found = resolve_bin("codex", "/usr/bin:/bin", "/home/someone", |_| false);
        ...
        assert!(looked.contains(&"/home/someone/.local/bin/codex".to_string()));
    }
    ...
    fn the_path_wins_over_the_fallbacks() {
        let installed = ["/home/someone/.local/bin/codex", "/opt/homebrew/bin/codex"];
        let found = resolve_bin(
            "codex",
        ...
        assert_eq!(found, Ok("/home/someone/.local/bin/codex".to_string()));
    }
    ...
    fn an_explicit_path_is_taken_as_it_is() {
        let installed = ["/opt/homebrew/bin/codex"];
        let found = resolve_bin("/altro/posto/codex", "", "/home/someone", |c| {
    ...
    fn the_child_path_carries_the_interpreter_dir() {
        let p = enriched_path("/usr/bin:/bin", "/home/someone");
        ...
        assert!(p.contains("/home/someone/.local/bin"));
    }

    /// Un percorso già ricco non deve gonfiarsi di doppioni a ogni giro.
    #[test]
    fn the_child_path_never_repeats_a_dir() {
        let p = enriched_path("/opt/homebrew/bin:/usr/bin:/opt/homebrew/bin/", "/home/someone");
