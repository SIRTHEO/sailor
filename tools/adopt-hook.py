...
gancio e la riga da sostituire, tutto il resto è identico.
    ...
    adopt-hook.py cd-guard 'python3 /home/someone/.claude/skills/hooks/cd-guard.py'
...
SETTINGS = '/home/someone/.claude/settings.json'
...
def swap(old: str, new: str, everywhere: bool = False) -> None:
    ...
    shutil.copy(SETTINGS, f'/home/someone/.claude/backups/settings.json.{stamp}')
