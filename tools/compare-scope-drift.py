...
SUITE = '/home/someone/other-repo/work/suite'
PACK = '/home/someone/other-repo/work/packages'
ME = '/home/someone/other-repo/work/a-service'
WA = '/home/someone/other-repo/work/a-client'
CONF = '/home/someone/.claude'
...
def casi():
    ...
    return [
        ...
        ('a-service', [{'command': f'pnpm --dir {ME} run test'}]),
        ('a-client', [{'file_path': f'{WA}/src/a.ts'}]),
        ('packages', [{'file_path': f'{PACK}/geo/x.ts'}]),
        ('dev-stack', [{'command': '/home/someone/other-repo/work/dev-stack/up.sh'}]),
        ('configurazione', [{'file_path': f'{CONF}/rules/x.md'}]),
        ('personale via /personal/', [{'file_path': '/home/someone/personal/sailor/x.ts'}]),
        ('personale via orca/general', [{'command': 'ls /home/someone/orca/general'}]),
        ...
        ('un trattino dopo il nome del repo conta come suite',
         [{'file_path': '/home/someone/other-repo/work/suite-vecchia/x.ts'}]),
        ('una lettera dopo il nome del repo no',
         [{'file_path': '/home/someone/other-repo/work/suiteXX/x.ts'}]),
        ('un worktree Orca conta come il suo repo',
         [{'command': 'git -C /home/someone/orca/workspaces/a-client/x status'}]),
        ...
        ('un worktree di packages non conta',
         [{'command': 'ls /home/someone/orca/workspaces/packages/wt'}]),
