...
PY = Path('/home/someone/other-repo/work/.claude/scripts/reachability.py')

LISTING_LOADED = "PID\tStatus\tLabel\n-\t0\twork.other-repo.vivo\n-\t0\twork.other-repo.spento\n"
DISABLED_ONE = '"work.other-repo.spento" => disabled\n'
...
SCENARI: list[tuple[str, dict]] = [
    ('una radice e cio che si accende, non cio che esiste', {
        ...
        'plist': {'vivo.plist': '<key>Label</key><string>work.other-repo.vivo</string>'
                                '\nbash da-vivo.sh',
                  'spento.plist': '<key>Label</key><string>work.other-repo.spento</string>'
                                  '\nbash da-spento.sh'},
    ...
    ('la catena dietro un launchd spento e in pausa, non dimenticata', {
        ...
        'plist': {'spento.plist': '<key>Label</key><string>work.other-repo.spento</string>'
                                  '\npython motore.py'},
    ...
    ('nessun plist caricato: tutti dormienti', {
        ...
        'disabled': '',
        'plist': {'uno.plist': '<key>Label</key><string>work.other-repo.uno</string>'
                               '\nbash dietro.sh'},
    ...
    ('disabled batte loaded', {
        'settings': {'settings.json': '{"h": "echo"}'},
        'launchctl': "PID\tStatus\tLabel\n-\t0\twork.other-repo.due\n",
        'disabled': '"work.other-repo.due" => disabled\n',
        'plist': {'due.plist': '<key>Label</key><string>work.other-repo.due</string>'
                               '\nbash dietro.sh'},
        'ws_scripts': {'dietro.sh': HOOK},
    }),
