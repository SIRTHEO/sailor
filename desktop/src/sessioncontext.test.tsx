...
function bridge(overrides: Record<string, unknown> = {}) {
  const answers: Record<string, unknown> = {
    ...
    quota: { windows: [{ engine: "engine · an-account", unit: "five_hour", window: "session", lasts_seconds: 18_000, spent_fraction: 0.25, observed_at: 1, resets_at: null }], unreachable: [] },
